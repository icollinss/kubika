...
const translations = {
  pt: {
    ...
    contacts: {
      ...
      tabService:          "Serviços",
      tabNotes:            "Notas",
      smartOrders:         "Encomendas",
      smartOutstanding:    "Em aberto",
      smartBills:          "Fat. Fornecedor",
      smartServices:       "Serviços",
      noSalesOrders:       "Sem encomendas de venda.",
      noPurchaseOrders:    "Sem ordens de compra.",
      noAccountingData:    "Sem movimentos contabilísticos.",
      noNotes:             "Sem notas ainda.",
      creditLimit:         "Limite de crédito",
      paymentTerms:        "Prazo de pagamento",
      days:                "dias",
      salesInvoices:       "Faturas de Venda",
      supplierInvoicesLabel: "Faturas de Fornecedor",
      colNumber:           "Número",
      colDate:             "Data",
      colStatus:           "Estado",
      colTotal:            "Total",
      colDueDate:          "Vencimento",
      colOutstanding:      "Em aberto",
      colDebit:            "Débito",
      colCredit:           "Crédito",
      colBalance:          "Saldo",
      ...
      deleteConfirm:       "Eliminar este contacto? Esta acção não pode ser desfeita.",
      tabStatement:        "Extracto",
      totalBilled:         "Total Facturado",
      totalPaid:           "Total Pago",
      noStatement:         "Sem movimentos de conta.",
    },
  ...
  en: {
    ...
    contacts: {
      ...
      tabNotes:            "Notes",
      smartOrders:         "Orders",
      smartOutstanding:    "Outstanding",
      smartBills:          "Supplier Bills",
      ...
      supplierInvoicesLabel: "Supplier Invoices",
      colNumber:           "Number",
      colDate:             "Date",
      colStatus:           "Status",
      colTotal:            "Total",
      ...
      deleteConfirm:       "Delete this contact? This action cannot be undone.",
      tabStatement:        "Statement",
      totalBilled:         "Total Billed",
      totalPaid:           "Total Paid",
      noStatement:         "No account movements.",
    },
  ...
  fr: {
    ...
    contacts: {
      ...
      tabService:          "Services",
      tabNotes:            "Notes",
      smartOrders:         "Commandes",
      smartOutstanding:    "En cours",
      smartBills:          "Fact. Fournisseur",
      smartServices:       "Services",
      noSalesOrders:       "Pas de commandes de vente.",
      noPurchaseOrders:    "Pas de bons d'achat.",
      noAccountingData:    "Pas de mouvements comptables.",
      noNotes:             "Pas encore de notes.",
      creditLimit:         "Limite de crédit",
      paymentTerms:        "Conditions de paiement",
      days:                "jours",
      salesInvoices:       "Factures de vente",
      supplierInvoicesLabel: "Factures fournisseur",
      colNumber:           "Numéro",
      colDate:             "Date",
      colStatus:           "Statut",
      colTotal:            "Total",
      colDueDate:          "Échéance",
      colOutstanding:      "Solde dû",
      colDebit:            "Débit",
      colCredit:           "Crédit",
      colBalance:          "Solde",
      ...
      noStatement:         "Aucun mouvement de compte.",
    },
